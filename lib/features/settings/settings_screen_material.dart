...
Widget _settingsTrailingChevron(
  ...
  final maxLabel =
      (MediaQuery.sizeOf(context).width * 0.32).clamp(72.0, 160.0);
  return Row(
              ...
              children: [
                ListTile(
                  ...
                  onTap: () => _showTimeoutPicker(
                      context, ref, settings.timeoutSeconds),
                ),
                ...
                ListTile(
                  ...
                  onTap: () => context
                      .push(AppRoutes.settingsDefaultHeaders),
                ),
                _settingsDivider(context),
                ListTile(
                  leading:
                      Icon(Icons.mediation_outlined, color: Colors.indigo),
            ...
            _SettingsGroupMaterial(
              children: [
                ...
                ListTile(
                  ...
                  trailing:
                      Icon(Icons.chevron_right, size: 16, color: tertiary),
                  onTap: () => _launchLegalUrl(context,
                      LegalUrls.termsOfService, 'Terms of Service'),
                ),
                _settingsDivider(context),
                ListTile(
